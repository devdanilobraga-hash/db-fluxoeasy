...
const { getClientes, getClienteById, updateCliente, uploadLogo, upload, updateDadosInternos, getAllClientes, createCliente, getClienteByCpfCnpj } = require('../controllers/clienteController');
